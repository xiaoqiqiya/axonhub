...
func TestConvertOutputToMessage(t *testing.T) {
	tests := []struct {
			...
			output: []Item{
				{
					...
					Content: &Input{Items: []Item{
						{Type: "output_text", Text: new("Hello world")},
					}},
				},
			},
			validate: func(t *testing.T, msg llm.Message) {
		...
		},
		{
			...
			output: []Item{
				{Type: "output_text", Text: new("Direct text")},
			},
			validate: func(t *testing.T, msg llm.Message) {
				require.NotNil(t, msg.Content.Content)
			...
			output: []Item{
				{
					...
					EncryptedContent: new("encrypted_data"),
				},
			},
			validate: func(t *testing.T, msg llm.Message) {
			...
			output: []Item{
				{
					...
					EncryptedContent: new("summary_enc"),
					CreatedBy:        new("system"),
				},
			},
			validate: func(t *testing.T, msg llm.Message) {
				require.Len(t, msg.Content.MultipleContent, 1)
			...
			output: []Item{
				{
					...
					Type: "message",
					Content: &Input{Items: []Item{
						{Type: "output_text", Text: new("Some text")},
					}},
				},
				{
					ID:               "cmp_002",
					Type:             "compaction",
					EncryptedContent: new("enc_mixed"),
				},
			},
			validate: func(t *testing.T, msg llm.Message) {
			...
			output: []Item{
				{
					...
					Type: "message",
					Content: &Input{Items: []Item{
						{Type: "output_text", Text: new("before")},
					}},
				},
				{
					ID:               "cmp_mid",
					Type:             "compaction",
					EncryptedContent: new("enc_mid"),
				},
				{
					ID:   "msg_after",
					Type: "message",
					Content: &Input{Items: []Item{
						{Type: "output_text", Text: new("after")},
					}},
				},
			},
			validate: func(t *testing.T, msg llm.Message) {
			...
			output: []Item{
				{
					...
					EncryptedContent: new("enc_reason"),
				},
				{
					ID:   "msg_r",
					Type: "message",
