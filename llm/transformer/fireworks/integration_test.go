	...
	llmReq := &llm.Request{
		...
		Messages: []llm.Message{
			...
			},
			{
				Role: "user",
				Content: llm.MessageContent{
					Content: new("What is 2+2?"),
				},
				Reasoning: new("The user is asking a simple math question."),
			},
			{
				Role: "assistant",
				Content: llm.MessageContent{
					Content: new("The answer is 4."),
				},
				Reasoning:        new("I'm calculating 2+2=4."),
				ReasoningContent: new("Step 1: Add 2 and 2. Step 2: The result is 4."),
			},
			{
				Role: "user",
				Content: llm.MessageContent{
					Content: new("Can you explain why?"),
				},
				Reasoning: new("User wants an explanation."),
			},
		},
	}
		...
		Messages: []llm.Message{
			{
				Role: "system",
				Content: llm.MessageContent{
					Content: new("You are a helpful AI assistant."),
				},
			},
			{
				Role: "user",
				Content: llm.MessageContent{
					Content: new("Hello, can you help me?"),
				},
				Reasoning: new("User is greeting and asking for help"),
			},
			{
				Role: "assistant",
				Content: llm.MessageContent{
					Content: new("Of course! I'd be happy to help."),
				},
				Reasoning:        new("Responding affirmatively to user's request"),
				ReasoningContent: new("I should be polite and helpful"),
			},
		},
	}
		...
		Messages: []llm.Message{
			{
				...
				Reasoning: new("reasoning to be stripped"),
			},
		},
	}
...
func TestIntegration_LargeRequestWithReasoning(t *testing.T) {
	...
	for i := range 10 {
		messages = append(messages, llm.Message{
			...
			Reasoning: new("Reasoning for message " + string(rune('0'+i))),
		})
		messages = append(messages, llm.Message{
			Role: "assistant",
			Content: llm.MessageContent{
				Content: new("Response " + string(rune('0'+i))),
			},
			Reasoning:        new("Assistant reasoning " + string(rune('0'+i))),
			ReasoningContent: new("Assistant reasoning content " + string(rune('0'+i))),
		})
	}
		...
		Messages: []llm.Message{
			{
				...
				Reasoning:        new("some reasoning that should be stripped"),
				ReasoningContent: new("some reasoning content that should be stripped"),
			},
		},
	}
